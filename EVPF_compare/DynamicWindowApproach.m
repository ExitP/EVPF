function DWA = DynamicWindowApproach(x, y, theta, x_goal_path, y_goal_path, globalPathTrackingRange,  position_accuracy, obstacle, dT, simTimeMax,Success_Num)
