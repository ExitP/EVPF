function [F_va,F_va1,F_va2,F_va3,F_vr,obst_dist,Vor]=ds_virtual_force_SVPF_v(Ro,X_o,X_r,O_o,K_o,dynamic,VR,xo,t,dt,tstep,total_time)
...
%      if norm(R_c)<=Ro(i)
        ...
        eta_vr = R_c1*b0.*((cvr+(Ro(i)).^2)./(cvr+(norm(R_c)).^3)).^beta;  %3
