function VAPF = VortexArtificialPotentialField_dynamic(x, y, theta, x_goal_path, y_goal_path, globalPathTrackingRange,  position_accuracy, obstacle, dynamic,angles,dT, simTimeMax,Success_Num)
